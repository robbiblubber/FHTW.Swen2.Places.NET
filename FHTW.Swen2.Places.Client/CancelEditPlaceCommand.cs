...
{
    /// <summary>This class implements a command to cancel editing a place.</summary>
    public class CancelEditPlaceCommand: ICommand
    {
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////
        // private members                                                                                          //
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        internal CancelEditPlaceCommand(PlaceDetailViewModel parent)
        {
            _Parent = parent;
        }
